                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-muted mb-1">{{ $data['start'] }}</div>
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          ...
                          <div class="h5 mb-0 font-weight-bold text-dark mb-1">{{ $data['start'] }}</div>
                          <small class="text-muted">{{ $data['transportasi'] }} ({{ $data['kode'] }})</small>
                        </div>
                        <div class="col-auto text-right">
                          <div class="h5 mb-0 font-weight-bold text-dark">Rp. {{ number_format($data['harga'], 0, ',', '.') }}</div>
                          <small class="text-muted">/Orang</small>
                          @if ($data['kursi'] < 50)
                            <p class="text-dark" style="margin: 0;"><small>{{ $data['kursi'] }} Kursi Tersedia</small></p>
                          @endif
                        </div>
                      </div>
                    </div>
