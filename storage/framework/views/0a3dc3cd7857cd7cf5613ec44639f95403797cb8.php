          ...
          <div class="col-12 mb-4">
              <div class="card o-hidden border-0 shadow h-100 py-2">
                <div class="card-body text-center">
                  ...
                  <a href="<?php echo e(url('/')); ?>" class="btn btn-dark" style="font-size: 16px; border-radius: 10rem;">
                    Cari Ticket
                  </a>
                </div>
              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Downloads\Ticket-Laravel\resources\views/client/history.blade.php ENDPATH**/ ?>