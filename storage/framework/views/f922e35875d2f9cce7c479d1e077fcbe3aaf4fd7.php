...
<body id="page-top">
  ...
  <?php else: ?>
    <?php if(Auth::user()->level == 'Admin'): ?>
            ...
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span>
                  ...
                  <a href="https://github.com/salsabilakmal" target="_blank"
                    >Salsabila Akmal
                </span>
              </div>
            </div>
      ...
      <!-- End of Page Wrapper -->
    <?php else: ?>
      <div class="bg-gradient-dark" style="height: 160px; border-bottom-left-radius: 50% 20px; border-bottom-right-radius: 50% 20px;">
        <nav class="navbar navbar-expand navbar-dark topbar mb-4">
          <div class="container">
            <a class="title" href="<?php echo e(url('/')); ?>">
              <div class="title-icon rotate-n-15">
                <i class="fas fa-ticket-alt"></i>
              </div>
              <div class="title-text mx-3 text-gray">Ticket</div>
            </a>
            <!-- Topbar Navbar -->
...
<?php /**PATH C:\Users\HP\Downloads\Ticket-Laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>