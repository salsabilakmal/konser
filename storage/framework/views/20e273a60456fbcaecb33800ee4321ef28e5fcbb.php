                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-muted mb-1"><?php echo e($data['start']); ?></div>
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          ...
                          <div class="h5 mb-0 font-weight-bold text-dark mb-1"><?php echo e($data['start']); ?></div>
                          <small class="text-muted"><?php echo e($data['transportasi']); ?> (<?php echo e($data['kode']); ?>)</small>
                        </div>
                        <div class="col-auto text-right">
                          <div class="h5 mb-0 font-weight-bold text-dark">Rp. <?php echo e(number_format($data['harga'], 0, ',', '.')); ?></div>
                          <small class="text-muted">/Orang</small>
                          <?php if($data['kursi'] < 50): ?>
                            <p class="text-dark" style="margin: 0;"><small><?php echo e($data['kursi']); ?> Kursi Tersedia</small></p>
                          <?php endif; ?>
                        </div>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Downloads\Ticket-Laravel\resources\views/client/show.blade.php ENDPATH**/ ?>