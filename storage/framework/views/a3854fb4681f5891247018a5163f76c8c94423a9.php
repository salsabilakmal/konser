...
<?php $__env->startSection('heading', 'Event'); ?>
        ...
        <form action="<?php echo e(route('rute.store')); ?>" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="tujuan">Nama Event</label>
              <input
                type="text"
                class="form-control"
                id="tujuan"
            ...
            <div class="form-group">
              <label for="start">Tema Event</label>
              <input
                type="text"
                class="form-control"
                id="start"
            ...
            <div class="form-group">
              <label for="jam">Tanggal Event</label>
              <input
                type="time"
                class="form-control"
                id="jam"
            ...
            <div class="form-group">
              <label for="transportasi_id">Kursi</label><br>
              <select
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Downloads\Ticket-Laravel\resources\views/server/rute/index.blade.php ENDPATH**/ ?>