      ...
      <div class="card shadow">
        <div class="card-body">
          ...
          <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
              <label for="start">Event</label><br>
              <select
                class="select2 form-control"
                id="start"
                name="Event"
            ...
            <button type="submit" class="btn btn-dark btn-user btn-block mt-4" style="font-size: 16px">
              Cari Tiket
            </button>
          </form>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Downloads\Ticket-Laravel\resources\views/client/index.blade.php ENDPATH**/ ?>