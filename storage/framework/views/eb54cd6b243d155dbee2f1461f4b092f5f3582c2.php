...
<?php $__env->startSection('content'); ?>
  <div class="row justify-content-center" style="margin-bottom: 35px;">
    ...
    <div class="col-12">
    <?php endif; ?>
      <div class="card shadow h-100" style="border-top: .25rem solid #6e707e">
        <div class="card-body">
          <div class="row no-gutters align-items-center justify-content-center">
            ...
            <div class="col-auto">
              <span class="title">
                ...
                <div class="title-text ml-1" style="color:gray">Ticket</div>
              </span>
            </div>
          </div>
        </div>
        ...
        <?php if($data->status == "Belum Bayar" && Auth::user()->level != "Penumpang"): ?>
          <div class="card-body">
            <a href="<?php echo e(route('pembayaran', $data->id)); ?>" class="btn btn-dark btn-block btn-sm text-white">Verifikasi</a>
          </div>
        <?php endif; ?>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Downloads\Ticket-Laravel\resources\views/server/laporan/show.blade.php ENDPATH**/ ?>